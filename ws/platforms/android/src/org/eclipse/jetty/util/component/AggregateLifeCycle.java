 ...
 * <p>
 * If adding a bean that is shared between multiple {@link org.eclipse.jetty.util.component.AggregateLifeCycle} instances, then it should be started before being added, so it is unmanaged, or
