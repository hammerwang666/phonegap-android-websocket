...
{   
    ...
    interface OnTextMessage extends WebSocket
    {
         ...
         * The maximum size of text message that may be aggregated from multiple frames is set with {@link org.eclipse.jetty.websocket.WebSocket.Connection#setMaxTextMessageSize(int)}.
    ...
    interface OnBinaryMessage extends WebSocket
    {
         ...
         * The maximum size of binary message that may be aggregated from multiple frames is set with {@link org.eclipse.jetty.websocket.WebSocket.Connection#setMaxBinaryMessageSize(int)}.
         * @param data
         * @param offset
         * @param length
         */
    ...
    /**
     * A  Connection interface is passed to a WebSocket instance via the {@link org.eclipse.jetty.websocket.WebSocket#onOpen(org.eclipse.jetty.websocket.WebSocket.Connection)} to
